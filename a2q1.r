...
#From these plots I have found that the distribution of each individual species' petal lengths show strong signs of normality, and likely follow a normal distribution. However, the combination of the samples does not seem to follow a normal distribution. This is likely because of our previous findings that indicate that the total distribution is a sum of three distributions of varying mean and variance, and therefore not normal itself. #nolint